...
public class NatureDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Place>().HasData(
            new Place { Id = 1, Name = "Parque Nacional Iztaccíhuatl", Description = "Parque con senderos y miradores", Category = "Parque", Latitude = 19.2078418, Longitude = -98.6645425, ElevationMeters = 3900, Accessible = true, EntryFee = 50, OpeningHours = "08:00-18:00", CreatedAt = new DateTime(2025, 9, 12, 3, 52, 0) },
            new Place { Id = 2, Name = "Cascada Cola de Caballo", Description = "Cascada famosa en Nuevo León", Category = "Cascada", Latitude = 19.349646, Longitude = -98.2325284, ElevationMeters = 50, Accessible = true, EntryFee = 0, OpeningHours = "08:00-17:00", CreatedAt = new DateTime(2025, 9, 12, 3, 52, 0) },
            new Place { Id = 3, Name = "Mirador del Cerro de la Silla", Description = "Mirador icónico en Monterrey", Category = "Mirador", Latitude = 25.8932289, Longitude = -100.7900199, ElevationMeters = 1800, Accessible = true, EntryFee = 0, OpeningHours = "06:00-20:00", CreatedAt = new DateTime(2025, 9, 12, 3, 52, 0) },
            new Place { Id = 4, Name = "Parque Ecológico Chipinque", Description = "Parque natural con senderos", Category = "Parque", Latitude = 25.6187488, Longitude = -100.3628164, ElevationMeters = 2000, Accessible = true, EntryFee = 20, OpeningHours = "07:00-19:00", CreatedAt = new DateTime(2025, 9, 12, 3, 52, 0) },
            new Place { Id = 5, Name = "Cascada de Basaseacic", Description = "Cascada más alta de Chihuahua", Category = "Cascada", Latitude = 28.1704994, Longitude = -108.2199465, ElevationMeters = 1800, Accessible = false, EntryFee = 30, OpeningHours = "08:00-17:00", CreatedAt = new DateTime(2025, 9, 12, 3, 52, 0) },
            new Place { Id = 6, Name = "Mirador La Bufa", Description = "Mirador panorámico en Zacatecas", Category = "Mirador", Latitude = 20.7305417, Longitude = -104.8288242, ElevationMeters = 2500, Accessible = true, EntryFee = 10, OpeningHours = "06:00-20:00", CreatedAt = new DateTime(2025, 9, 12, 3, 52, 0) },
            new Place { Id = 7, Name = "Parque Nacional Cumbres de Monterrey", Description = "Parque con diversas rutas de senderismo", Category = "Parque", Latitude = 25.4134793, Longitude = -100.3243244, ElevationMeters = 2600, Accessible = true, EntryFee = 40, OpeningHours = "07:00-18:00", CreatedAt = new DateTime(2025, 9, 12, 3, 52, 0) },
            new Place { Id = 8, Name = "Cascada de Piedra Volada", Description = "Cascada en el cañón de Chihuahua", Category = "Cascada", Latitude = 28.1428034, Longitude = -108.2298299, ElevationMeters = 1700, Accessible = false, EntryFee = 25, OpeningHours = "08:00-17:00", CreatedAt = new DateTime(2025, 9, 12, 3, 52, 0) },
            new Place { Id = 9, Name = "Mirador de la Peña", Description = "Mirador en Bernal, Queretáro", Category = "Mirador", Latitude = 20.5387363, Longitude = -100.4036776, ElevationMeters = 2100, Accessible = true, EntryFee = 15, OpeningHours = "06:00-19:00", CreatedAt = new DateTime(2025, 9, 12, 3, 52, 0) },
            new Place { Id = 10, Name = "Parque Nacional Nevado de Toluca", Description = "Parque con montaña y lagunas", Category = "Parque", Latitude = 19.1085703, Longitude = -99.757344, ElevationMeters = 4600, Accessible = true, EntryFee = 50, OpeningHours = "07:00-18:00", CreatedAt = new DateTime(2025, 9, 12, 3, 52, 0) }
        );
